...
| Scheduler has a deployable trigger and overlap protection | `infrastructure/cron/atlas-scheduler` (installable crontab line); all 6 scheduled jobs have `withoutOverlapping()`/`onOneServer()` |
