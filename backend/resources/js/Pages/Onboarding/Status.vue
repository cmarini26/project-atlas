  ...
  <AuthLayout>
    <div class="text-center">
      ...
      <div v-if="isFailed">
        ...
        <p class="text-sm text-[var(--color-text-muted)] mb-6">This is often temporary — your site may have been briefly unreachable. Try a different URL if the problem persists.</p>
