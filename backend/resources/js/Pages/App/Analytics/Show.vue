...
<template>
  ...
  <div class="max-w-3xl">
    ...
    <div class="flex items-start gap-3 mb-6">
      <Link href="/app/analytics" class="mt-1 text-[var(--color-text-muted)] hover:text-[var(--color-text-secondary)] transition-colors duration-[var(--duration-fast)]" aria-label="Back">
